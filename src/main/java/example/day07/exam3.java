...
public class exam3 {
    public static void main(String[] args) {
        ...
        // 2. 스트림API, 리스트객체.stream().중간연산1().중간연산2().최종연산()     -> 중간 연산은 여러개 가능, 최종 연산은 하나만
            ...
            // 스트림이란? 컬렉션(리스트) 인스턴스를 흐름단위로 중간연산과 최종연산 제공 API(미리만든 클래스/메소드)

            // 메소드 레퍼런스 API : 미리 만들어진 메소드를 조금 더 간편하게 호출하는 방법을 제공하는 API
            // System.out.print("메소드호출 정석"); --> (x) --> System.out::print("메소드호출 레퍼런스 방식");
